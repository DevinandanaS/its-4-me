...
function App() {
  ...
  const dailySchedules = {
    ...
    Monday: {
      ...
      actual: [
        { name: "Work", value: 55, color: "#FF6B6B" },
        { name: "Sleep", value: 10, color: "#4ECDC4" },
        { name: "Family", value: 13, color: "#45B7D1" },
        { name: "Exercise", value: 12, color: "#96CEB4" },
        { name: "Social", value: 10, color: "#FFEEAD" },
      ],
    },
    ...
    Tuesday: {
      ...
      actual: [
        { name: "Work", value: 50, color: "#FF6B6B" },
        { name: "Sleep", value: 10, color: "#4ECDC4" },
        { name: "Family", value: 10, color: "#45B7D1" },
        { name: "Exercise", value: 20, color: "#96CEB4" },
        { name: "Social", value: 10, color: "#FFEEAD" },
      ],
    },
    Wednesday: {
    ...
    Saturday: {
      ...
      actual: [
        { name: "Work", value: 10, color: "#FF6B6B" },
        { name: "Sleep", value: 20, color: "#4ECDC4" },
        { name: "Family", value: 40, color: "#45B7D1" },
        { name: "Exercise", value: 20, color: "#96CEB4" },
        { name: "Social", value: 10, color: "#FFEEAD" },
      ],
    },
